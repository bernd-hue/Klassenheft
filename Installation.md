...
Schritt für Schritt. Rechne mit etwa fünfzehn Minuten. Stand 10.09.2026, Version 17.6.
...
5. Unten ins Textfeld **Version 17.6** schreiben und auf **Commit changes** klicken.
...
- *"Geladen ist Klassenheft, Version 17.6. Das ist die Fassung, die auch auf der Adresse liegt."* → alles in Ordnung, weiter mit Schritt 3.
- *"Geladen ist Klassenheft, Version 9. Auf der Adresse liegt bereits Version 17.6."* → dein Browser zeigt noch die alte Fassung aus seinem Zwischenspeicher. Darunter steht ein Knopf **Version 17.6 jetzt laden**. Einmal darauf tippen, fertig. **Deine Klassen und Noten bleiben dabei erhalten**, sie liegen in einem eigenen Speicher, den das Aktualisieren nicht berührt.
...
- [ ] Am MacBook unter Einstellungen, Abschnitt FASSUNG, geprüft, dass Version 17.6 geladen ist
