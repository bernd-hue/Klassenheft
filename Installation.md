...
Schritt für Schritt. Rechne mit etwa fünfzehn Minuten. Stand 08.09.2026, Version 15.
...
5. Unten ins Textfeld **Version 15** schreiben und auf **Commit changes** klicken.
...
Am MacBook **bernd-hue.github.io/Klassenheft** aufrufen, dann unten auf **Einstellungen** und ganz nach unten scrollen. Dort steht seit Version 15 ein eigener Abschnitt **FASSUNG**.

**Die App sagt dir selbst, woran du bist:**

- *"Geladen ist Klassenheft, Version 15. Das ist die Fassung, die auch auf der Adresse liegt."* → alles in Ordnung, weiter mit Schritt 3.
- *"Geladen ist Klassenheft, Version 9. Auf der Adresse liegt bereits Version 15."* → dein Browser zeigt noch die alte Fassung aus seinem Zwischenspeicher. Darunter steht ein Knopf **Version 15 jetzt laden**. Einmal darauf tippen, fertig. **Deine Klassen und Noten bleiben dabei erhalten**, sie liegen in einem eigenen Speicher, den das Aktualisieren nicht berührt.
...
- [ ] Am MacBook unter Einstellungen, Abschnitt FASSUNG, geprüft, dass Version 15 geladen ist
